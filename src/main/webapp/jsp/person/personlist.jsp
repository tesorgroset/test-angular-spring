...
<script type="text/javascript" src="/rest-angular/js/person.js"></script>
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a class="badge badge-primary" href="javascript:deletePerson(${person.id})"><fmt:message key="botones.borrar" /></a></td>
    </tr>
    </c:forEach>
  </tbody>
</table>
