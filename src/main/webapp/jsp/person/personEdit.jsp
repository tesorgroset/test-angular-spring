...
<div>
	<form:hidden path="id" />
    <div class="form-row"> 
      <div class="form-group col-md-4"><label><fmt:message key="personas.nombre" />:</label>&nbsp;<form:input path="firstName" type="text" required="true" minlength="3" maxlength="17" class="form-control" /></div>
